...
module Api.Enum.User_select_column exposing (User_select_column(..), decoder, fromString, list, toString)
...
list =
    [ Admin, Email, FirstName, Id, LastName, RecentDocs, TimeStamp, Username ]
