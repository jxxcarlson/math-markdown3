...
module Api.Object.User_min_fields exposing (email, firstName, id, lastName, timeEnrolled, timeUpdated, username)
...
timeEnrolled : SelectionSet (Maybe Int) Api.Object.User_min_fields
timeEnrolled =
    Object.selectionForField "(Maybe Int)" "timeEnrolled" [] (Decode.int |> Decode.nullable)


timeUpdated : SelectionSet (Maybe Int) Api.Object.User_min_fields
timeUpdated =
