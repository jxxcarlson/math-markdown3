...
module Api.Object.Document exposing (ChildrenOptionalArguments, TagsOptionalArguments, authorIdentifier, children, content, docType, id, public, slug, tags, timeStamp, title, user)
