...
var zwilias$elm_rosetree$Tree$Zipper$fromForest = F2(
	function (t, ts) {
		return zwilias$elm_rosetree$Tree$Zipper$Zipper(
			{after: ts, before: _List_Nil, crumbs: _List_Nil, focus: t});
	});
var author$project$Main$content = function (_n0) {
	var t = _n0.a;
	var ts = _n0.b;
	return A2(zwilias$elm_rosetree$Tree$Zipper$fromForest, t, ts);
}(
	A2(
		author$project$Main$indexedMap,
		function (tIdx) {
			return zwilias$elm_rosetree$Tree$indexedMap(
				F2(
					function (nIdx, label) {
						return {
							content: label,
							id: _Utils_Tuple2(tIdx, nIdx)
						};
					}));
		},
		_Utils_Tuple2(
			zwilias$elm_rosetree$Tree$singleton('Introduction'),
			_List_fromArray(
				[
					A2(
					zwilias$elm_rosetree$Tree$tree,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									zwilias$elm_rosetree$Tree$singleton('A first conversation'),
									zwilias$elm_rosetree$Tree$singleton('Energy, a second conversation')
								])),
							zwilias$elm_rosetree$Tree$singleton('The meteor that killed the dinosaurs'),
							zwilias$elm_rosetree$Tree$singleton('The Parable of the Neutrino')
						])),
					A2(
					zwilias$elm_rosetree$Tree$tree,
					'Time',
					_List_fromArray(
						[
							zwilias$elm_rosetree$Tree$singleton('The Pendulum'),
							zwilias$elm_rosetree$Tree$singleton('Atomic clocks')
						])),
					A2(
					zwilias$elm_rosetree$Tree$tree,
					...
					_List_fromArray(
						[
							zwilias$elm_rosetree$Tree$singleton('Galileo\'s Experiment'),
							zwilias$elm_rosetree$Tree$singleton('Speed of sound'),
							A2(
							zwilias$elm_rosetree$Tree$tree,
							'Speed of Light',
							_List_fromArray(
								[
									zwilias$elm_rosetree$Tree$singleton('Roemer\'s experiment'),
									zwilias$elm_rosetree$Tree$singleton('Bradley\'s experiment'),
									zwilias$elm_rosetree$Tree$singleton('Michelson\'s experiment')
								]))
						])),
					zwilias$elm_rosetree$Tree$singleton('Distance'),
					zwilias$elm_rosetree$Tree$singleton('Light'),
					zwilias$elm_rosetree$Tree$singleton('Heat'),
					zwilias$elm_rosetree$Tree$singleton('Sound')
				]))));
var elm$core$Basics$False = {$: 'False'};
var author$project$Main$initialModel = {data: author$project$Main$content, toggle: false};
	...
	function (msg, model) {
		if (msg.$ === 'Focus') {
			...
			return _Utils_update(
				model,
				{
					data: A2(author$project$Main$focus, id, model.data)
				});
		} else {
			return _Utils_update(
				model,
...
var author$project$Main$expandCollapseButton = A2(
	mdgriffith$elm_ui$Element$Input$button,
	_List_Nil,
	{
		label: mdgriffith$elm_ui$Element$text('Expand/Collapse'),
		onPress: elm$core$Maybe$Just(author$project$Main$Toggle)
	});
...
var author$project$Main$viewNode = F2(
	function (showAll, t) {
		var xs = showAll ? _List_fromArray(
			[
				A2(
				...
				A2(
					elm$core$List$map,
					author$project$Main$viewNode(showAll),
					zwilias$elm_rosetree$Tree$children(t)))
			]) : _List_Nil;
		var l = zwilias$elm_rosetree$Tree$label(t);
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_Nil,
			A2(
				...
				A2(
					...
					_List_Nil,
					{
						label: A2(
							...
							_List_Nil,
							mdgriffith$elm_ui$Element$text(l.content)),
						onPress: elm$core$Maybe$Just(
							author$project$Main$Focus(l.id))
					}),
				xs));
	});
...
var author$project$Main$viewAfter = F2(
	function (t, z) {
		return A2(
			elm$core$List$map,
			author$project$Main$viewNode(t),
			zwilias$elm_rosetree$Tree$Zipper$siblingsAfterFocus(z));
	});
...
var author$project$Main$viewBefore = F2(
	function (t, z) {
		return A2(
			elm$core$List$map,
			author$project$Main$viewNode(t),
...
var author$project$Main$inAncestors = F3(
	function (toggle, zipper, current) {
		var _n0 = zwilias$elm_rosetree$Tree$Zipper$parent(zipper);
		if (_n0.$ === 'Just') {
			var parent = _n0.a;
			return A3(
				author$project$Main$inAncestors,
				toggle,
				parent,
				A2(
					mdgriffith$elm_ui$Element$column,
					...
					elm$core$List$concat(
						_List_fromArray(
							[
								A2(author$project$Main$viewBefore, toggle, parent),
								_List_fromArray(
								[
									A2(
									mdgriffith$elm_ui$Element$column,
										...
										[
											...
											_List_Nil,
											{
												label: mdgriffith$elm_ui$Element$text(
													zwilias$elm_rosetree$Tree$Zipper$label(parent).content),
												onPress: elm$core$Maybe$Just(
													author$project$Main$Focus(
														zwilias$elm_rosetree$Tree$Zipper$label(parent).id))
											}),
											current
										]))
								]),
								A2(author$project$Main$viewAfter, toggle, parent)
							]))));
		} else {
			return current;
		}
...
var author$project$Main$darkRed = A3(mdgriffith$elm_ui$Element$rgb, 0.5, 0.0, 0.0);
...
var author$project$Main$viewSelf = F2(
	function (toggle, t) {
		var l = zwilias$elm_rosetree$Tree$label(t);
		return A2(
			mdgriffith$elm_ui$Element$column,
				...
				[
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$Font$color(author$project$Main$darkRed)
						]),
					mdgriffith$elm_ui$Element$text(l.content)),
					A2(
					mdgriffith$elm_ui$Element$column,
					...
					A2(
						elm$core$List$map,
						author$project$Main$viewNode(toggle),
						zwilias$elm_rosetree$Tree$children(t)))
				]));
	});
var author$project$Main$viewZ = F2(
	function (t, z) {
		return A3(
			author$project$Main$inAncestors,
			t,
			...
			A2(
				...
				elm$core$List$concat(
					_List_fromArray(
						[
							A2(author$project$Main$viewBefore, t, z),
							_List_fromArray(
							[
								A2(
								author$project$Main$viewSelf,
								t,
								zwilias$elm_rosetree$Tree$Zipper$tree(z))
							]),
							A2(author$project$Main$viewAfter, t, z)
						]))));
	});
		...
		A2(
			...
			_List_fromArray(
				[
					...
					author$project$Main$expandCollapseButton,
					A2(author$project$Main$viewZ, model.toggle, model.data)
				])));
};
